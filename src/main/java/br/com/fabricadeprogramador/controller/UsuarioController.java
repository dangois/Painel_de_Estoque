...
public class UsuarioController extends HttpServlet {
	...
	// Para testar usar QueryString:
	// localhost:8080/fabricaweb/usucontroller.do?nome=ze&login=z&senha=abc
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
			throws ServletException, IOException {
		resp.setContentType("text/html"); //Para entender que o response é html
